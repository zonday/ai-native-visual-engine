...
export function createDocumentRegistry(
  ...
  registry.register(
    "create-page",
    entry(
      createPageEntry.handler as DocumentHandlerEntry["handler"],
      createPageEntry.inverse as DocumentHandlerEntry["inverse"],
    ),
  );
  registry.register(
    "rename-page",
    entry(
      renamePageEntry.handler as DocumentHandlerEntry["handler"],
      renamePageEntry.inverse as DocumentHandlerEntry["inverse"],
    ),
  );
  registry.register(
    "remove-page",
    entry(
      removePageEntry.handler as DocumentHandlerEntry["handler"],
      removePageEntry.inverse as DocumentHandlerEntry["inverse"],
    ),
  );
  registry.register(
    "reorder-page",
    entry(
      reorderPageEntry.handler as DocumentHandlerEntry["handler"],
      reorderPageEntry.inverse as DocumentHandlerEntry["inverse"],
    ),
  );
  registry.register(
    "update-page-route",
    entry(
      updatePageRouteEntry.handler as DocumentHandlerEntry["handler"],
      updatePageRouteEntry.inverse as DocumentHandlerEntry["inverse"],
    ),
  );
  registry.register(
    "set-document-theme",
    entry(
      setDocumentThemeEntry.handler as DocumentHandlerEntry["handler"],
      setDocumentThemeEntry.inverse as DocumentHandlerEntry["inverse"],
    ),
  );
  registry.register(
    "set-page-theme",
    entry(
      setPageThemeEntry.handler as DocumentHandlerEntry["handler"],
      setPageThemeEntry.inverse as DocumentHandlerEntry["inverse"],
    ),
  );
  registry.register(
    "batch-document-actions",
    registry.createBatchEntry() as any,
  );
  return registry;
}
...
export function createDefaultDocumentRegistries(
  ...
  return {
    handlerRegistry:
      split.handlerRegistry as unknown as DocumentHandlerRegistry,
